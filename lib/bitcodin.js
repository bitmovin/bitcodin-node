...
Bitcodin.prototype = {
    ...
    input: {
        ...
        analayze: function (inputId) {
            if (isNaN(inputId))
                return Q.defer().reject('inputId is no number');
    ...
    output: {
        ...
        getDetails: function (outputId) {
            if (isNaN(outputId))
                return Q.defer().reject('outputId is no number');
    ...
    encodingProfile: {
        ...
        get: function (encodingProfileId) {
            if (isNaN(encodingProfileId))
                return Q.defer().reject('encodingProfileId is no number');
    ...
    job: {
        ...
        getDetails: function (jobId) {
            if (isNaN(jobId))
                return Q.defer().reject('jobId is no number');
    ...
    statistic: {
        ...
        jobs: function (fromDate, toDate) {
            ...
            if (fromDate === undefined) {
                ...
                return Q.defer().reject('fromDate is not a date');
            }
